      ...
      <ScrollView style={styles.container}>
        <View >
          <View style={styles.imgContainer}>
            <TouchableOpacity style={styles.btnfl} onPress={() => { navigation.goBack() }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 10, alignItems: 'center', backgroundColor: 'white' }}>
            ...
            <Icon name={favorite ? 'heart' : 'heart-outline'} size={24} color={favorite ? COLOR.custom : 'gray'} onPress={() => { clickfavotite() }} />
          </View>

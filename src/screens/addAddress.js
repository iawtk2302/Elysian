...
const AddAddress = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ backgroundColor: 'white', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', height: 45, marginBottom: 40 }}>
            ...
            <Button title='Hoàn thành' disabled={!isComplete} color={COLORS.custom} onPress={onSubmit} />
        </View>
    )
}

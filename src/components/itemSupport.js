...
const ItemSupport = ({item}) => {
    const press=()=>{
        switch(item.type){
            ...
            case 'instagram':{
                Linking.openURL('https://www.instagram.com/gongchavietnam/?fbclid=IwAR3dHSSKh3veA29cfZ1TalLgNZ6I2-ZJJgq-86m5kcUoHSsfg7NkxMcijaU')
                return
            }
        }
    }
  return (
    <TouchableOpacity style={{height:65,backgroundColor:'white', flexDirection:'row'}} onPress={press}>
      <View style={{width:'15%', height:65, alignItems:'center',justifyContent:'center'}}>
      ...
      <View style={{width:'15%', height:65,justifyContent:'center',alignItems:'center'}}>
